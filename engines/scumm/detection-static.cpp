...
#include "scumm/detection-static.h"
#include "scumm/file.h"
#include "scumm/file_nes.h"

// Common items between engine and metaengine, related to querying saves.
...
/**
 * All helper functions, for game detection.
 */
...
const char *ScummMetaEngine::getEngineId() const {
    return "scumm";
}
...
SaveStateDescriptor ScummMetaEngine::querySaveMetaInfos(const char *target, int slot) const {
	...
	Scumm::SaveStateMetaInfos *infoPtr = &infos;
...
REGISTER_PLUGIN_STATIC(SCUMM, PLUGIN_TYPE_METAENGINE, ScummMetaEngine);
