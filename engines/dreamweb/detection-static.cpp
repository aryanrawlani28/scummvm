...
#include "dreamweb/detection-static.h"

DreamWebMetaEngine::DreamWebMetaEngine() :
    AdvancedMetaEngine(DreamWeb::gameDescriptions, sizeof(DreamWeb::DreamWebGameDescription), dreamWebGames, gameGuiOptions) {
		_guiOptions = GUIO1(GUIO_NOMIDI);
}

const char *DreamWebMetaEngine::getEngineId() const {
	return "dreamweb";
}

const char *DreamWebMetaEngine::getName() const {
    return "DreamWeb";
}

const char *DreamWebMetaEngine::getOriginalCopyright() const {
