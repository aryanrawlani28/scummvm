...
/**
 * Resources common between engines & metaengines.
 * This is not header guarded, it is only meant to be
 * included once by the main agi.h file, and once by
 * detection-static.cpp file, to perform the necessary
 * detections.
 */
namespace Agi {
